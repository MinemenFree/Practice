...
public enum Locale {
	...
	SETTINGS_GLOBAL_CHAT_ON("SETTINGS.GLOBAL_CHAT_ON"),
	SETTINGS_GLOBAL_CHAT_OFF("SETTINGS.GLOBAL_CHAT_OFF"),
	SETTINGS_SCOREBOARD_ON("SETTINGS.SCOREBOARD_ON"),
	SETTINGS_SCOREBOARD_OFF("SETTINGS.SCOREBOARD_OFF"),
	SETTINGS_ALLOW_SPECTATORS_ON("SETTINGS.ALLOW_SPECTATORS_ON"),
	SETTINGS_ALLOW_SPECTATORS_OFF("SETTINGS.ALLOW_SPECTATORS_OFF"),
        SETTINGS_NEW_CONVERSATIONS_ON("SETTINGS.NEW_CONVERSATIONS_ON"),
        SETTINGS_NEW_CONVERSATIONS_OFF("SETTINGS.NEW_CONVERSATIONS_OFF"),
        SETTINGS_DUEL_REQUESTS_ON("SETTINGS.DUEL_REQUESTS_ON"),
        SETTINGS_DUEL_REQUESTS_OFF("SETTINGS.DUEL_REQUESTS_OFF"),
        SETTINGS_PRIVATE_MESSAGE_SOUNDS_ON("SETTINGS.PRIVATE_MESSAGE_SOUNDS_ON"),
        SETTINGS_PRIVATE_MESSAGE_SOUNDS_OFF("SETTINGS.PRIVATE_MESSAGE_SOUNDS_OFF"),
        SETTINGS_VANILLA_TAB_ON("SETTINGS.VANILLA_TAB_ON"),
        SETTINGS_VANILLA_TAB_OFF("SETTINGS.VANILLA_TAB_OFF"),
	...
	QUEUE_CANT_JOIN("QUEUE.CANT_JOIN"),
	...
	MATCH_CANT_DROP_SWORD("MATCH.CANT_DROP_SWORD"),
	...
	MATCH_DETAILS_SEPARATOR("MATCH.DETAILS_SEPARATOR"),
	...
	EVENT_FIELD_DOES_NOT_EXIST("EVENT.FIELD_DOES_NOT_EXIST"),
	EVENT_MAP_DOES_NOT_EXIST("EVENT.MAP_DOES_NOT_EXIST"),
	EVENT_MAP_ALREADY_EXISTS("EVENT.MAP_ALREADY_EXISTS"),
	EVENT_MAP_CREATION_USAGE("EVENT.MAP_CREATION_USAGE"),
	EVENT_MAP_STATUS_USAGE("EVENT.MAP_STATUS_USAGE"),
	EVENT_MAP_SETSPAWN_USAGE("EVENT.MAP_SETSPAWN_USAGE"),
	EVENT_MAP_DELETION_USAGE("EVENT.MAP_DELETION_USAGE"),
        EVENT_MAP_TYPE_NOT_VALID("EVENT.MAP_TYPE_NOT_VALID"),
	EVENT_CANT_JOIN_IN_PARTY("EVENT.CANT_JOIN_IN_PARTY"),
	EVENT_MUST_JOIN_IN_LOBBY("EVENT.MUST_JOIN_IN_LOBBY"),
	EVENT_IS_FULL("EVENT.IS_FULL"),
	EVENT_ALREADY_STARTED("EVENT.ALREADY_STARTED"),
	EVENT_NO_ACTIVE_EVENT("EVENT.NO_ACTIVE_EVENT"),
	...
	EVENT_SUMO_ROUND("EVENT.SUMO_ROUND"),
	...
	TOURNAMENT_COMMAND_USAGE("TOURNAMENT.COMMAND_USAGE"),
	TOURNAMENT_ADMIN_COMMAND_USAGE("TOURNAMENT.ADMIN_COMMAND_USAGE"),
	TOURNAMENT_NO_TOURNAMENT_FOUND("TOURNAMENT.NO_TOURNAMENT_FOUND"),
	TOURNAMENT_CANT_JOIN_IN_STATE("TOURNAMENT.CANT_JOIN_IN_STATE"),
	TOURNAMENT_ALREADY_IN_TOURNAMENT("TOURNAMENT.ALREADY_IN_TOURNAMENT"),
	TOURNAMENT_FORCE_STARTED("TOURNAMENT.FORCE_STARTED"),
