package rip.crystal.practice.event.game.map;

import rip.crystal.practice.cPractice;
import rip.crystal.practice.event.game.EventGame;
import rip.crystal.practice.event.game.map.impl.SpreadEventGameMap;
import rip.crystal.practice.event.game.map.impl.TeamEventGameMap;
