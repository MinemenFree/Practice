package rip.crystal.practice.event;

import rip.crystal.practice.event.game.EventGame;
import rip.crystal.practice.event.game.EventGameLogic;
import rip.crystal.practice.event.impl.brackets.BracketsEvent;
import rip.crystal.practice.event.impl.gulag.GulagEvent;
import rip.crystal.practice.event.impl.spleef.SpleefEvent;
import rip.crystal.practice.event.impl.sumo.SumoEvent;
import rip.crystal.practice.event.impl.tntrun.TNTRunEvent;
import rip.crystal.practice.event.impl.tnttag.TNTTagEvent;
